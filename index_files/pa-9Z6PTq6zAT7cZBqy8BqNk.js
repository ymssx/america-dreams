!function() {
    ...
    function p() {
        "visible" === document.visibilityState && document.hasFocus() && 0 === l ? l = Date.now() : "hidden" !== document.visibilityState && document.hasFocus() || (c = f(),
        l = 0,
        d())
    }
    function f() {
    ...
    function m(f, m) {
        ...
        c = 0,
        l = Date.now(),
        a || (document.addEventListener("visibilitychange", p),
        ...
        if ("auxclick" !== e.type || 1 === e.button) {
            var t, n = function(e) {
                for (; e && (void 0 === e.tagName || !b(e) || !e.href); )
                    e = e.parentNode;
                return e
            }(e.target), o = n && "string" == typeof n.href && n.href.split("?")[0];
            if (!E(n, 0)) {
                if (i.outboundLinks && (t = n) && "string" == typeof t.href && t.host && t.host !== location.host)
                    return L(e, n, {
    ...
    function x(e) {
        ...
        for (var o = 0; o < i.length; o++) {
            var a, r, s = i.item(o), u = s.match(/plausible-event-(.+)(=|--)(.+)/);
            u && (a = u[1],
            r = u[3].replace(/\+/g, " "),
    ...
    function S(e) {
        ...
        i.autoCapturePageviews && function(e) {
            function t(t) {
                (i.hashBasedRouting || !t || n !== location.pathname) && (n = location.pathname,
                e("pageview"))
            }
            var n, o = function() {
                t(!0)
        ...
        function() {
            function e(e) {
                if ("auxclick" !== e.type || 1 === e.button) {
                    for (var t, n, i, o = e.target, a = 0; a <= 3 && o; a++) {
                        if ((t = o) && t.tagName && "form" === t.tagName.toLowerCase())
                            return;
                        b(o) && (n = o),
                        k(o) && (i = o),
                        o = o.parentNode
            ...
            i.fileDownloads && "object" == typeof i.fileDownloads && Array.isArray(i.fileDownloads.fileExtensions) && (h = i.fileDownloads.fileExtensions),
            i.formSubmissions && document.addEventListener("submit", function(e) {
